...
import mail_icon from '../../assets/Things/mail_icon.svg'
import location_icon from '../../assets/Things/location_icon.svg'
import call_icon from '../../assets/Things/call_icon.svg'
const Contact = () => {
            ...
            <div className="contact-left">
                ...
                <div className="contact-details">
                    <div className="contact-detail">
                        <img src={mail_icon} alt='' /> <p>lakshyabapna03@gmail.com</p>
                    </div>
                    <div className="contact-detail">
                    <img src={call_icon} alt='' /> <p>+91 09352418414</p>
                    </div>
                    <div className="contact-detail">
